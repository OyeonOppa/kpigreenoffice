    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-display text-4xl md:text-6xl lg:text-7xl text-white leading-[1.2] tracking-tight"
        >
          {ABOUT.headingParts.before}{' '}
          <em className="italic text-white/60">{ABOUT.headingParts.accent}</em>
