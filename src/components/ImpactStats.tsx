...
/**
 * ตัวชี้วัดการลดคาร์บอนของทั้งองค์กร — อยู่ในหมวด "ผลลัพธ์" (#dashboard)
 *
 * เดิมบล็อกนี้อยู่ใน hero แล้วหมวดผลลัพธ์มีตัวเลขอีกชุดของตัวเอง ซึ่งขัดกันเอง
 * ตอนนี้เหลือที่เดียว อ่านจาก ORG_IMPACT แหล่งเดียว
 *
