...
export default function PartnersSection() {
  ...
  return (
    <section id="partners" ref={ref} className="bg-black py-20 md:py-28 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-display text-3xl md:text-5xl text-white tracking-tight mb-12"
        >
          {PARTNERS.heading}
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {PARTNERS.items.map((item, i) => {
            ...
            return (
              ...
              >
                <span className="liquid-glass rounded-full p-3 text-white inline-block mb-6">
                  <Icon size={20} />
                </span>
