  ...
  return (
    <section className="min-h-screen overflow-hidden relative flex flex-col bg-canvas">
        ...
        <nav className="liquid-glass rounded-full max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center">
            <a href="#" className="flex items-center gap-2">
              <Leaf size={24} className="text-accent-deep" />
          ...
          <a
            href="#actions"
            className="liquid-glass rounded-full px-6 py-2 text-ink text-sm font-medium hover:bg-ink/5 transition-colors"
          >
            {HERO.contactLabel}
          </a>
        </nav>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12 text-center -translate-y-[20%]">
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-ink tracking-tight leading-[1.15] mb-8">
        ...
        <p className="text-ink/70 text-sm leading-relaxed px-4 max-w-xl mb-8">{HERO.subtitle}</p>
