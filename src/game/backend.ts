...
export interface GameBackend {
  ...
  /**
   * ออกจากห้องแบบตั้งใจ (กดปุ่ม "ออกจากห้อง") — ต่างจากปิดแท็บ/เน็ตหลุดที่ต้องกลับเข้ามาได้เอง
   * บอกเซิร์ฟเวอร์ให้เอาผู้เล่นออกจริง แล้วปิดการเชื่อมต่อ ไม่ให้ auto-reconnect
   */
