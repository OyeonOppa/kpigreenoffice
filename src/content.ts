...
export const LIVE_GAME = {
  ...
  joinPath: '#/live',
  hostPath: '#/live/host',
  // เกมแข่งสดไม่มีล็อกอิน — allowedDomain ใช้กับแคมเปญป่า (#/forest) เท่านั้น
  allowedDomain: 'kpi.ac.th',
  // ⚠️ ก่อนวันงานต้องเปลี่ยนเป็นรายชื่อสำนัก/กองจริง — ผู้เล่นเลือกตอนตั้งชื่อ ใช้ทำลีดเดอร์บอร์ดแบบทีม
  //    ปล่อย "(ตัวอย่าง)" ไว้หน้างาน = ผู้เล่นเลือกทีมมั่ว กระดานทีมใช้ไม่ได้
  teams: [
