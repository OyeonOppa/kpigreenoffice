...
export const GAMES_PROMO = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        'ลากขยะลงถังให้ถูกและให้ไว 15 ข้อ ข้อละ 10 วินาที ตอบไวได้คะแนนเยอะกว่า จบเกมประกาศ 10 อันดับ (เข้าเล่นด้วยบัญชี kpi.ac.th)',
      href: '#/live',
      cta: 'เข้าห้องแข่ง',
      featured: true,
    },
...
export const LIVE_GAME = {
  ...
  intro:
    'แข่งแยกขยะพร้อมกันทั้งหน่วยงาน 15 ข้อ ลากขยะลงถังให้ถูกและให้ไว ยิ่งไวยิ่งได้คะแนน',
  joinPath: '#/live',
  hostPath: '#/live/host',
...
// ชิ้นส่วนตัวละครประจำตัวผู้เล่น — ผสมกันได้ 28 × 8 × 12 × 6 = 16,128 ลุค
...
// bases เลือกเฉพาะ emoji ที่เป็น "หัว/หน้า" เต็มกรอบ ตำแหน่งตาจะได้ตรงกันพอให้ใส่แว่นทับได้
...
export const AVATAR_COMBOS =
  ...
  AVATAR_PARTS.hats.length *
  AVATAR_PARTS.gears.length
