...
//
// ตรวจทานคำเฉลยครบทั้ง 30 ข้อแล้ว — ถูกต้องตามมาตรฐาน 4 สีทุกข้อ
//
// checkLocal = คำตอบพลิกได้จริงตามว่าหน่วยงานมี "จุดรับเฉพาะ" หรือไม่
//   ตอนนี้เหลือข้อเดียวคือกล่องนม UHT (มีจุดรับ = ถังเหลือง / ไม่มี = ถังทั่วไป)
//   ของ e-waste (มือถือ ตลับหมึก อะแดปเตอร์) ไม่ใส่ checkLocal แล้ว เพราะคำตอบคือถังแดงเสมอ
//   จุดรับ e-waste เป็นแค่ "ทางที่ดีกว่า" ไม่ได้ทำให้ทิ้งถังทั่วไปได้
//
...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    bin: 'recycle',
    source: SRC.recycle,
    // คำตอบคือถังเหลือง โดยถือว่าแคมเปญตั้ง "จุดรับกล่องเครื่องดื่ม" ไว้แล้ว
    // ถ้ายืนยันแล้วว่างานนี้ไม่มีจุดรับจริงๆ ให้เปลี่ยน bin เป็น 'general' (แบนเนอร์ checkLocal
    // จะอธิบายให้เอง) — อย่าปล่อยให้คำตอบขัดกับสิ่งที่ผู้เล่นทำได้จริงหน้างาน
    checkLocal: true,
    explanation:
      'กล่องนม UHT รีไซเคิลได้ ตัวกล่องเป็นกระดาษ พลาสติก และฟอยล์อัดซ้อนกัน โรงงานเฉพาะทางแยกชั้นแล้วแปรรูปเป็นแผ่นหลังคาหรือไม้อัดได้ ก่อนทิ้งต้องล้าง ผ่าให้แบน ตากแห้ง แล้วหย่อนลงจุดรับกล่องเครื่องดื่มของโครงการ ถ้าที่ทำงานยังไม่มีจุดรับเฉพาะ กล่องนมจะถูกทิ้งรวมเป็นขยะทั่วไป การตั้งจุดรับจึงเป็นส่วนหนึ่งของแคมเปญ',
  },
  ...
  },
  {
    ...
    source: SRC.hazard,
    explanation:
      'หลอดไฟเสียทุกชนิดทิ้งลงถังแดง หลอดฟลูออเรสเซนต์และหลอดตะเกียบมีไอปรอทที่ฟุ้งเป็นอันตรายต่อระบบประสาทถ้าแตกในที่ปิด ส่วนหลอด LED มีชิ้นส่วนอิเล็กทรอนิกส์ที่ต้องถอดแยก ก่อนทิ้งควรใส่กล่องเดิมหรือห่อกระดาษหนา และห้ามทุบให้แตกเด็ดขาด',
  },
  {
    id: 'spray-can',
    emoji: '🧴',
  ...
  },
  {
    ...
    source: SRC.ewaste,
    explanation:
      'มือถือเป็นขยะอิเล็กทรอนิกส์ ทิ้งลงถังแดงเสมอ ห้ามลงถังทั่วไปหรือถังรีไซเคิล เพราะข้างในมีทั้งของมีค่าอย่างทองแดง และของอันตรายอย่างตะกั่วกับลิเทียมในแบตเตอรี่ ถ้าที่ทำงานมีจุดรับ e-waste ให้ส่งจุดนั้นจะดีกว่า เพราะถอดแยกชิ้นส่วนได้ครบ และควรล้างข้อมูลในเครื่องก่อนส่งต่อทุกครั้ง',
  },
  {
    id: 'expired-medicine',
    emoji: '💊',
  ...
  },
  {
    ...
    source: SRC.ewaste,
    explanation:
      'ตลับหมึกพิมพ์ทิ้งลงถังแดง เพราะผงหมึกเป็นผงเคมีละเอียดที่ฟุ้งเข้าปอดได้ และตลับยังมีชิ้นส่วนอิเล็กทรอนิกส์อยู่ข้างใน ถ้าเป็นไปได้ ส่งคืนตามโครงการรับตลับเปล่าของผู้ผลิตจะดีกว่า เพราะนำไปเติมหมึกใช้ใหม่ได้ทั้งตลับ',
  },
  {
    id: 'old-adapter',
    emoji: '🔌',
    ...
    source: SRC.ewaste,
    explanation:
      'สายชาร์จและอะแดปเตอร์เป็นขยะอิเล็กทรอนิกส์ ทิ้งลงถังแดง ไม่ใช่ถังโลหะรีไซเคิล เพราะแม้ข้างในจะมีทองแดงที่รีไซเคิลได้ แต่ก็มีสารหน่วงไฟกับตะกั่วบัดกรีปนอยู่ ถ้าที่ทำงานมีจุดรับ e-waste ให้ส่งจุดนั้นจะดีที่สุด',
  },
  {
    id: 'insecticide-can',
    emoji: '🦟',
