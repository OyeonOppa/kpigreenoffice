...
//
// ตรวจทานคำเฉลยครบทุกข้อแล้ว — ถูกต้องตามมาตรฐาน 4 สี ทุกข้อทิ้งได้ด้วยถัง 4 สีที่หน่วยงานมี
// ไม่มีข้อไหนต้องพึ่ง "จุดรับเฉพาะ" (จุดรับกล่องนม / จุด e-waste) ที่ยังไม่มี
//
// field `checkLocal` ยังอยู่ในโครงสร้างแต่ตอนนี้ไม่มีข้อไหนใช้ — ใส่กลับได้เมื่อหน่วยงานตั้งจุดรับ
// (เช่น กล่องนม UHT ที่ถอดออกไปก่อน)
//
...
export const QUESTIONS: Question[] = [
  ...
  // กล่องนม UHT: ถอดออกชั่วคราว — คำตอบพลิกได้ตามว่ามี "จุดรับกล่องเครื่องดื่ม" ไหม
  // ตอนนี้หน่วยงานยังไม่มีจุดรับ ใส่กลับเมื่อไรที่ตั้งจุดรับแล้ว (bin: 'recycle')
  ...
  },
  {
    ...
    source: SRC.ewaste,
    explanation:
      'มือถือเป็นขยะอิเล็กทรอนิกส์ ทิ้งลงถังแดงเสมอ ห้ามลงถังทั่วไปหรือถังรีไซเคิล เพราะข้างในมีทั้งของมีค่าอย่างทองแดง และของอันตรายอย่างตะกั่วกับลิเทียมในแบตเตอรี่ และควรล้างข้อมูลในเครื่องก่อนทิ้งหรือส่งต่อทุกครั้ง',
  },
  {
    id: 'expired-medicine',
    emoji: '💊',
    ...
    source: SRC.hazard,
    explanation:
      'ยาหมดอายุทิ้งลงถังแดง ห้ามทิ้งรวมกับขยะทั่วไปและห้ามเทลงชักโครกเด็ดขาด เพราะตัวยาจะปนเปื้อนแหล่งน้ำและเร่งให้เชื้อดื้อยา',
  },
  {
    id: 'correction-fluid',
    emoji: '🖊️',
  ...
  },
  {
    ...
    source: SRC.ewaste,
    explanation:
      'ตลับหมึกพิมพ์ทิ้งลงถังแดง เพราะผงหมึกเป็นผงเคมีละเอียดที่ฟุ้งเข้าปอดได้ และตลับยังมีชิ้นส่วนอิเล็กทรอนิกส์อยู่ข้างใน ห้ามทิ้งรวมกับขยะทั่วไปหรือถังกระดาษ',
  },
  {
    id: 'old-adapter',
    emoji: '🔌',
    ...
    source: SRC.ewaste,
    explanation:
      'สายชาร์จและอะแดปเตอร์เป็นขยะอิเล็กทรอนิกส์ ทิ้งลงถังแดง ไม่ใช่ถังโลหะรีไซเคิล เพราะแม้ข้างในจะมีทองแดงที่รีไซเคิลได้ แต่ก็มีสารหน่วงไฟกับตะกั่วบัดกรีปนอยู่',
  },
  {
    id: 'insecticide-can',
    emoji: '🦟',
